"""
Django settings for bookaffordableride_42933 project.
...
ROOT_URLCONF = 'bookaffordableride_42933.urls'
...
WSGI_APPLICATION = 'bookaffordableride_42933.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "bookaffordableride_42933 API",
    "DESCRIPTION": "API documentation for bookaffordableride_42933 App",
    "VERSION": "v1",
}
