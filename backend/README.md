...
## Project Structure
    ...
    ├── bookaffordableride_42933  # Django project configurations
...
1. Clone this repo and `cd bookaffordableride_42933`
...
2. Clone this repo and `cd bookaffordableride_42933`
